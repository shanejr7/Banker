                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="hero-2-content">
                            ...
                            <p>Lending and finding money has never been this easy, we let you be your own boss.<br>Lend or borrow based on your pre-approved qualifications.
                                <br><br>Welcome back Banker!</p>
                            <div class="hero-btn">
...
<!-- team -->
    ...
    <script>
      ...
      let email = $("input[name=email_2]").val();
