...
<body>
                          ...
                          <!--   <li class="nav-item"><a href="#" class="nav-link active">Portfolio <i
                            ...
                            <li class="nav-item"><a href="#" class="nav-link active">Pages <i
                               ...
                               <!--      <li class="nav-item"><a href="pricing.html" class="nav-link">Pricing</a></li> -->
                                    ...
                                    Calculation</a></li>
                                      <li class="nav-item"><a href="/borrower-form" class="nav-link active">Loan Form</a></li>
    ...
    <div class="loan-form-area pt-100 pb-100">
        ...
        <div class="container">
            ...
            <div class="loan-form">
                <form method="POST" action="/borrower-form-submit">
                    @csrf
                    <!--row -->
                        ...
                        <div class="footer-wrapper mb-30">
                            ...
                            <div class="subscribes-form">
                                ...
                                <form>
                                    ...
                                    <input name="email_10" class="getemail" placeholder="Enter email " type="email">
                                </form>
    ...
    <!-- /JS -->
      ...
      let email = $("input[name=email_10]").val();
