                            ...
                            <li class="nav-item"><a href="#" class="nav-link active">Pages <i
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item"><a href="loan-calculation.html" class="nav-link">Loan
                                            Calculation</a></li>
                                    <li class="nav-item"><a href="loans.html" class="nav-link active">Loan Form</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Purpose of loan">
                            </div>
                        </div>
                        <!-- /col -->
                        <!-- col -->
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                                ...
                                <select>
                                    ...
                                    <option value="">70,000 - 80,000</option>
