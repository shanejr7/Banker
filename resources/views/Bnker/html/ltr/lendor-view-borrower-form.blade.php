<!doctype html>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="banner-content banner-padding">
                        ...
                        <p>Welcome to your <span style="color:red">Banker</span> opportunity. </p>
                    </div>
                </div>
                <!-- /col -->
                <!-- col -->
    ...
    <div class="loan-section">
       ...
       @endif
       <form method="POST" action="/lendor-borrower-form-apply">
        @csrf
                        ...
                        <div class="loan-filter-form">
                            <div class="thirty form">
                                <div class="accrue-field-amount">
                                    <p><label>Loan Amount:</label><input name="loan_amount" type="text" class="amount" value="${{{$form[0]->loan_amount}}}" disabled></p>
                                </div>
                                <div class="accrue-field-rate">
                                    <p><label>Rate (APR):</label><input name="interest_rate" type="text" class="rate" value="{{{$form[0]->interest_rate}}}%" disabled></p>
                                </div>
                                <div class="accrue-field-term">
                                    @if($form[0]->term == 'none')
                                    <p><label>Term:</label><input name="term" type="text" class="term" value="12m" disabled><small>Format: 12m, 36m, 3y, 7y</small></p>
                                    @endif
                                    @if($form[0]->term != 'none')
                                    <p><label>Term:</label><input name="term" type="text" class="term" value="{{{$form[0]->term}}}" disabled><small>Format: 12m, 36m, 3y, 7y</small></p>
            ...
            <div class="col-lg-5 col-12 wow fadeInRight">
                ...
                <div class="loan-confirm-form">
                    <div class="thirty">
                        ...
                        <button class="tran3s apply-button">REQUEST LOAN APPROVAL</button>
                        @endif
    ...
    <div class="container">
                            ...
                            <div class="subscribes-form">
                                <div>
                                    <form>
                                        ...
                                        <input name="email_14" class="getemail" placeholder="Enter email " type="email">
                                    </form>
        ...
        <script >
           $(".post_subscribe_button").click(function(event){
              ...
              let email = $("input[name=email_14]").val();
